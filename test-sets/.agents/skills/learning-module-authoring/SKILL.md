...
## 4. Writing Pitfalls check
Reference `learning-modules-authoring-pitfalls.md` in `C:\Users\reyna\OneDrive\Documents\marnie_quiz\test-sets\Reference Documents\learning-modules-authoring-pitfalls.md` for the complete list of pitfalls and how to avoid them and be sure to check against it.