  ...
  gemini: [
    {
      ...
      isRecommended: true,
      isFreeTier: true,
      description: "Fast multimodal flagship for STEM reasoning, derivations, and board exam problem solving.",
    },
    {
      ...
      isMultimodal: false,
      isFreeTier: true,
      description: "Ultra high-throughput lightweight generation.",
    },
    {
      id: "gemini-1.5-flash",
      ...
      isMultimodal: true,
      isFreeTier: true,
      description: "1M token context window for full syllabus and question set ingestion.",
    },
    {
      id: "gemini-1.5-pro",
      name: "Gemini 1.5 Pro",
      ...
      isMultimodal: true,
      isFreeTier: true,
      description: "Deep multi-step reasoning and complex derivations.",
    },
  ],
