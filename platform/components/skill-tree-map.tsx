...
> = {
  ...
  GEAS: {
    ...
    nodes: [
      ...
      { code: "GEAS-07", displayCode: "GEAS 07", name: "Electromagnetics", icon: "🌐", description: "Maxwell's equations, Poynting vector, boundary conditions" },
      { code: "GEAS-08", displayCode: "GEAS 08", name: "ECE Laws & Ethics", icon: "⚖️", description: "RA 9292, PEC, NTC regulations, engineering code of ethics" },
      { code: "GEAS-09", displayCode: "GEAS 09", name: "Material Science", icon: "💎", description: "Crystal structures, phase diagrams, polymers, ceramics" },
      { code: "GEAS-10", displayCode: "GEAS 10", name: "Computer Programming", icon: "🖥️", description: "Algorithms, flowcharts, data structures, C/C++" },
      { code: "GEAS-11", displayCode: "GEAS 11", name: "Environmental Science", icon: "🌱", description: "Ecology, waste management, environmental laws" },
      { code: "GEAS-12", displayCode: "GEAS 12", name: "Technopreneurship", icon: "🚀", description: "Innovation, startups, business models, IP protection" },
    ],
  },
  EST: {
    label: "EST",
